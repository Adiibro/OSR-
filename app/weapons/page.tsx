...
export default function WeaponsPage() {
  const weaponsList = [
    { name: "Movie Weapon Style 1", img: "/weapons/IMG-20240716-WA0076.jpg" },
    { name: "Movie Weapon Style 2", img: "/weapons/IMG-20240716-WA0077.jpg" },
    { name: "Movie Weapon Style 3", img: "/weapons/IMG-20240716-WA0078.jpg" },
    { name: "Movie Weapon Style 4", img: "/weapons/IMG-20240716-WA0079.jpg" },
    { name: "Movie Weapon Style 5", img: "/weapons/IMG-20240716-WA0080.jpg" },
    { name: "Movie Weapon Style 6", img: "/weapons/IMG-20240716-WA0081.jpg" },
    { name: "Movie Weapon Style 7", img: "/weapons/IMG-20240716-WA0082.jpg" },
    { name: "Movie Weapon Style 8", img: "/weapons/IMG-20240716-WA0083.jpg" },
    { name: "Movie Weapon Style 9", img: "/weapons/IMG-20240716-WA0084.jpg" },
    { name: "Movie Weapon Style 10", img: "/weapons/IMG-20240716-WA0085.jpg" },
    { name: "Movie Weapon Style 11", img: "/weapons/IMG-20240716-WA0086.jpg" },
    { name: "Movie Weapon Style 12", img: "/weapons/IMG-20240716-WA0087.jpg" },
    { name: "Movie Weapon Style 13", img: "/weapons/IMG-20240716-WA0088.jpg" },
    { name: "Movie Weapon Style 14", img: "/weapons/IMG-20240716-WA0089.jpg" },
    { name: "Movie Weapon Style 15", img: "/weapons/IMG-20240716-WA0090.jpg" },
    { name: "Movie Weapon Style 16", img: "/weapons/IMG-20240716-WA0091.jpg" },
    { name: "Movie Weapon Style 17", img: "/weapons/IMG-20240716-WA0092.jpg" },
    { name: "Movie Weapon Style 18", img: "/weapons/IMG-20240716-WA0096.jpg" }
  ];
          ...
          <div className="bg-white rounded-[40px] shadow-sm border border-gray-100 p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1 text-left">
              ...
              <p className="text-gray-400 text-xs md:text-sm font-medium border-l border-gray-200 pl-3 mb-8">
                Historic replicas — artistic arms & ceremonial pieces. Cinema-grade custom fabrication.
              </p>
              <a 
            ...
            <div className="w-full md:w-1/3 aspect-square relative rounded-[32px] overflow-hidden shadow-md bg-gray-50 flex items-center justify-center">
              <img 
                src="https://images.unsplash.com/photo-1595590424283-b8f17842773f?q=80&w=400&auto=format&fit=crop" 
                alt="Weapon Prop" 
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-[10px] text-gray-400 font-medium mb-12">
            Each weapon hand-crafted — inquire directly via WhatsApp
          </p>

          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
            {weaponsList.map((item, idx) => (
